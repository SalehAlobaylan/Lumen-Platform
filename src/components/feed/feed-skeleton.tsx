        ...
        <div className="relative w-full h-full snap-start shrink-0 overflow-hidden bg-black">
            ...
            <div className="absolute bottom-20 left-0 right-16 p-4 space-y-3">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Skeleton className="h-5 w-16 rounded-full bg-gray-800/60" />
                </div>

                {/* Title */}
                <Skeleton className="h-7 w-4/5 bg-gray-800" />
                ...
                {/* Duration */}
                <Skeleton className="h-3 w-12 bg-gray-800/60" />
            </div>
            ...
            <div className="absolute right-3 bottom-28 flex flex-col items-center gap-5">
                {[1, 2, 3, 4, 5].map((i) => (
                    <div key={i} className="flex flex-col items-center gap-1">
                        <Skeleton className="w-11 h-11 rounded-full bg-gray-800/50" />
                        {i <= 2 && <Skeleton className="h-3 w-6 bg-gray-800/30" />}
                    </div>
                ))}
            </div>
            ...
            <div className="absolute bottom-0 left-0 right-0 h-1 bg-gray-800/50">
                <Skeleton className="h-full w-1/4 bg-gray-700" />
            </div>
        </div>
    );
}
...
export function NewsSlideSkeleton() {
    return (
        <div className="w-full h-full snap-start shrink-0 overflow-hidden flex flex-col bg-[#f8f5f2]">
            {/* Header skeleton */}
            ...
            <main className="px-6 py-4 flex flex-col flex-grow overflow-hidden">
                ...
                <article className="mb-4 border-b-2 border-[#1a1a1a] pb-4 shrink-0">
                    {/* Featured Image */}
                    <Skeleton className="h-40 w-full bg-gray-300 mb-4 rounded-sm" />

                    {/* Meta info */}
                    <div className="flex items-center gap-2 mb-2">
                        <Skeleton className="h-3 w-20 bg-gray-300" />
                        <Skeleton className="h-3 w-2 bg-gray-300 rounded-full" />
                        <Skeleton className="h-3 w-14 bg-gray-300" />
                    </div>

                    {/* Title */}
                    <Skeleton className="h-8 w-full bg-gray-300 mb-2" />
                    <Skeleton className="h-8 w-3/4 bg-gray-300 mb-2" />

                    {/* Excerpt */}
                    <Skeleton className="h-4 w-full bg-gray-300/70 mb-1" />
                    <Skeleton className="h-4 w-4/5 bg-gray-300/70 mb-3" />
                ...
                <div className="flex flex-col space-y-1 overflow-hidden flex-1">
                    {[1, 2, 3].map((i) => (
                        <article key={i} className="py-3 border-b border-[#1a1a1a]/20 flex flex-col px-2">
                            <div className="flex justify-between items-baseline mb-0.5">
                                <Skeleton className="h-2 w-12 bg-gray-300" />
                                <Skeleton className="h-2 w-16 bg-gray-300" />
                            </div>
                            <Skeleton className="h-5 w-full bg-gray-300 mb-1" />
                            <Skeleton className="h-3 w-16 bg-gray-300/60" />
                        </article>
                    ))}
                </div>
                ...
                <div className="mt-auto pt-4 text-center shrink-0">
                    <Skeleton className="w-8 h-1 mx-auto rounded-full bg-gray-300/30" />
                </div>
            </main>
        </div>
    );
